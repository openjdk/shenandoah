...
#define GC_SHENANDOAH_FLAGS(develop,                                        \
  ...
  product(bool, ShenandoahEvacReserveOverflow, true, EXPERIMENTAL,          \
          ...
          "runs out of memory too early.")                                  \
                                                                            \
  product(uintx, ShenandoahOldEvacRatioPercent, 50, EXPERIMENTAL,           \
          ...
          "50%.  This limits both the promotion of aged young regions and " \
          ...
          "evacuation effort, doubling the amount of memory normally "      \
          "evacuated during young evacuations (so that old evacuations "    \
          "are 50% of the total evacuation, and young evacuates its "       \
          "normal amount.  If free memory is in short supply, this may "    \
          "result in paring back both young-gen and old-gen evacuations, "  \
          "such that the fraction of old is 50% (in the default "           \
